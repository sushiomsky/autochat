...
function localizePopup() {
  ...
  const sendMethodLabel =
    document.querySelector('label[for="sendMethod"]') ||
    document.evaluate(
      "//label[select[@id='sendMethod']]",
      document,
      null,
  ...
  document.querySelector('#sendMethod option[value="enter"]').textContent =
    `⌨️ ${t('sendMethodEnter')}`;
  document.querySelector('#sendMethod option[value="click"]').textContent =
    `🖱️ ${t('sendMethodClick')}`;
  document.getElementById('markSendButton').innerHTML = `📍 ${t('markSendButton')}`;

  // Messages
  const messagesLabel = document.evaluate(
    "//label[textarea[@id='messageList']]",
    document,
    null,
    XPathResult.FIRST_ORDERED_NODE_TYPE,
    null
  ...
  // Send mode
  const sendModeLabel = document.evaluate(
    "//label[select[@id='sendMode']]",
    document,
    null,
    XPathResult.FIRST_ORDERED_NODE_TYPE,
    null
  ...
  document.querySelector('#sendMode option[value="random"]').textContent =
    `🔀 ${t('sendModeRandom')}`;
  document.querySelector('#sendMode option[value="sequential"]').textContent =
    `➡️ ${t('sendModeSequential')}`;
  ...
  const minLabel = document.evaluate(
    "//label[input[@id='minInterval']]",
    document,
    null,
    XPathResult.FIRST_ORDERED_NODE_TYPE,
    null
  ...
  const maxLabel = document.evaluate(
    "//label[input[@id='maxInterval']]",
    document,
    null,
    XPathResult.FIRST_ORDERED_NODE_TYPE,
    null
...
function localizeSettingsModal() {
  ...
  const templateHelp = modal
    .querySelector('#templateVariables')
  ...
  const analyticsHelp = modal
    .querySelector('#analyticsEnabled')
    .closest('label').nextElementSibling;
  ...
  const activeHoursHelp = modal.querySelector('#activeHoursEnd').closest('label')
...
function localizePhraseModal() {
  ...
  // Default phrases
  const defaultStrong = Array.from(modal.querySelectorAll('strong')).find((el) =>
